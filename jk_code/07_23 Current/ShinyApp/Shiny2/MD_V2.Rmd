...
colnames(seu@meta.data)[colnames(seu@meta.data) == "supergroup"] ="Macula Densa Subtypes"
colnames(seu@meta.data)[colnames(seu@meta.data) == "manual_groups"] ="Deeper Macula Densa Subtypes"
...
levels(seu$`Macula Densa Subtypes`)[levels(seu$`Macula Densa Subtypes`) == "type_5"] <- "Type 5"
...
levels(seu$`Deeper Macula Densa Subtypes`)[levels(seu$`Deeper Macula Densa Subtypes`) == "type_1d"] <- "Type 1d"
...
levels(seu$`Deeper Macula Densa Subtypes`)[levels(seu$`Deeper Macula Densa Subtypes`) == "type_5"] <- "Type 5"
...
makeShinyApp(seu, scConf, gene.mapping = TRUE, gex.assay = "SCT", default.gene1 = "Nos1", default.gene2 = "Egf",
             ...
             default.multigene = c("Sfrp1","S100g","Ptger3","Pappa2","Il1f6","Hspa1b","Fos","Egf","Foxq1","Cxcl10","Ifitm3")) 
...
save(seu, file = here("jk_code", "MD_shiny2.rds"))
