...
pos.markers <-  markers %>% dplyr::filter(avg_log2FC > 1) %>%  arrange(desc(abs(avg_log2FC)))
#head(pos.markers, n = 50)
...
pos.markers <-  markers %>% dplyr::filter(avg_log2FC > 2.5) %>%  arrange(desc(abs(avg_log2FC)))
#head(pos.markers, n = 50)
...
pos.markers <-  markers %>% dplyr::filter(avg_log2FC > 3.5) %>%  arrange(desc(abs(avg_log2FC)))
#head(pos.markers, n = 50)
