...
type_2c_markers <- type_markers[type_markers$cluster == "type_2c", ]
...
```{r}
df<- type_2c_markers %>% arrange(desc(avg_log2FC))
...
pathway_type2c <- strsplit(pos_go$geneID, "/")

names(pathway_type2c) <- pos_go$Description 

pathway_type2c

VlnPlot(SO4, c("Aqp1","Calb1","Notch2"))
