...
colnames(seu@meta.data)[colnames(seu@meta.data) == "subclass2_MD"] ="Macula Densa Subtypes"
colnames(seu@meta.data)[colnames(seu@meta.data) == "subclass_MD"] ="Deeper Macula Densa Subtypes"
...
levels(seu$`Deeper Macula Densa Subtypes`)[levels(seu$`Deeper Macula Densa Subtypes`) == "type_1"] <- "Type 1"
...
levels(seu$`Deeper Macula Densa Subtypes`)[levels(seu$`Deeper Macula Densa Subtypes`) == "type_3"] <- "Type 3"
...
makeShinyApp(seu, scConf, gene.mapping = TRUE, gex.assay = "SCT", default.gene1 = "Nos1", default.gene2 = "Egf",
             ...
             default.multigene = c("Sfrp1", "Pappa2", "Aard", "Umod", "Ckb", "Foxq1", "Fos", "Jun", "Socs3", "Cxcl10","Isg15")) 
