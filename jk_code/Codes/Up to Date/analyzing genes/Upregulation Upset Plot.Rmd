...
type_4 <- extract_comb(m1,"1110") # type 123

type_12 <- extract_comb(m1,"1100") 

type_all <- extract_comb(m1,"1111")

list <- extract_comb(m1,"1111")
...
type4markers <- treatment_markers %>%
...
results_type2 <- pathway_analysis(subset(type2markers, avg_log2FC > 0.2), "type 2")
results_type3 <- pathway_analysis(subset(type3markers, avg_log2FC > 0.3), "type 3")
results_type4 <- pathway_analysis(subset(type4markers, avg_log2FC > 0.3), "type 123")
results_typeall <- pathway_analysis(subset(typeallmarkers, avg_log2FC > 0.2), "type all")
results_type12 <- pathway_analysis(subset(type12markers, avg_log2FC > 0.15), "type 1 and 2 ")
